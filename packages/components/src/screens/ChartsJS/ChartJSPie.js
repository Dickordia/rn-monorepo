...
export default function ChartsJSPie(props) {
    ...
    const onRefresh = () => {
        chart.current.reload(randomDataPieChart(6));
    }

    return (
        <SafeAreaView style={style.container}>
            <ChartJS ref={chart} type="doughnut" data={randomDataPieChart(5)} options={aOpt} />
